...
const Appointment = () => {
    ...
    const getAvailableSlots = async () => {
        ...
        let today = new Date()
        for (let i = 0; i < 7; i++) {
            //getting date with theire index 
            ...
            while (currentDate < endTime) {
                let fornmatedTime = currentDate.toLocaleTimeString([], { hour: '2-digit', minute: '2-digit', hour12: true })
                ...
                // increament time by thirty minutes 
        ...
        <div>
            ...
            <div className='flex flex-col sm:flex-row gap-4'>
                ...
                <div className='flex-1 border  border-gray-400 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0'>
                    ...
                    {/* docter about  */}
                    <div className='felx items-center gap-1 text-sm font-medium text-gray-900'>

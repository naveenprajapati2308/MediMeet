...
const addDoctor = async (req, res) => {
    try {
        ...
        // checking forall data to add dctor
        ...
        if (!validator.isEmail(email)) {
            return res.json({ success: false, message: "Type correct email" })
        }
...
//api to get all appointments list in admin panel 

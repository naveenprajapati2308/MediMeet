...
const registerUser = async (req, res) => {
    try {
        ...
        const hasgedPassword = await bcrypt.hash(password, salt)
...
const updateProfile = async (req, res) => {
    try {
        ...
        // Parse `address` JSON string (if sent as a string)
        let parsedAddress = {};
        try {
...
//API for cancle the appointment 
...
//api to make paymnet of appointment using razorpay 
...
const paymentRazorpay = async (req, res) => {
    try {
        ...
        if (!appointmentData || appointmentData.cancelled) {
            return res.json({ success: false, mesaage: 'Appointment Cancelled or not found' })

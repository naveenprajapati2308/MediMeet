            ...
            <div className='w-full flex flex-wrap gap-4 pt-5 gap-y-6'>
                {
                    doctors.map((item, index) => (
                        <div className='border border-blue-200 rounded-xl max-w-56 hover:translate-y-[-20px] transition-all duration-500 overflow-hidden cursor-pointer  group ' key={index}>
